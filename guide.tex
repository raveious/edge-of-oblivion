...
\section{Lights in the Night's Sky}

\section{From the Ashes}

\subsection{Bastions of Society}

\DndArea{North corner village}

\DndArea{Avalon}

\DndArea{Harmony}

\DndArea{North middle village}

\DndArea{Oblivion}

\DndArea{Knob Creek}

\DndArea{Coast village}

\DndArea{Knowhere}

\DndArea{Island Village}

\subsection{The Wastes}

\DndArea{Ruined City of Xerxes}

\DndArea{Middle Ruins}
